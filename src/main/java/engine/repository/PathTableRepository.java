...
public class PathTableRepository {
    ...
    private static final String SQL_REQUEST_RESULTTABLE = "with lemma_query as (select unnest(string_to_array(:includeLemma,';')) lemma), " +
    ...
    public List<PathTable> getResultTable(Integer siteId, String includeLemma) {
        return jdbcTemplate.query(SQL_REQUEST_RESULTTABLE

...
public class PathTableRepository {
    ...
    public List<PathTable> execQueryPageable(String sqlQuery, Pageable pageable) {
    ...
    public List<PathTable> execQuery(String sqlQuery) {
...
/*
    ...
    public List<PathTable> getResult_FromAllSites(String lemmaNames, Pageable pageable) {
        ...
        String sql = "select * from get_pages_generate_stmt(:lemmaNames)"
